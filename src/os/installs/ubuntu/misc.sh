...
install_package_via_snap "Spotify music" "spotify"
install_package "Gpick" "gpick"
install_package "Chrome gnome shell" "chrome-gnome-shell"
install_package "Chrome gnome shell manager" "gnome-shell-extension-manager"
